window.addEventListener( 'load', function () {
    ...
    const modes = {
        '2B+': {
            label: '2β⁺',
            title: 'Double beta plus decay'
        },
        '2B-': {
            label: '2β⁻',
            title: 'Double beta minus decay'
        },
        '2EC': {
            label: '2EC',
            title: 'Double electron capture'
        },
        '2N': {
            label: '2n',
            title: 'Two-neutron emission'
        },
        '2P': {
            label: '2p',
            title: 'Two-proton emission'
        },
        '3N': {
            label: '3n',
            title: 'Three-neutron emission'
        },
        '4N': {
            label: '4n',
            title: 'Four-neutron emission'
        },
        '5N': {
            label: '5n',
            title: 'Five-neutron emission'
        },
        '6N': {
            label: '6n',
            title: 'Six-neutron emission'
        },
        '7N': {
            label: '7n',
            title: 'Seven-neutron emission'
        },
        'A': {
            label: 'α',
            title: 'Alpha decay'
        ...
        'B+2P': {
            label: 'β⁺+2p',
            title: 'Beta+ + Two-proton emission'
        },
        'B+A': {
            label: 'β⁺+α',
            title: 'Beta+ + Alpha decay'
        },
        'B+P': {
            label: 'β⁺+p',
            title: 'Beta+ + Proton emission'
        },
        'B-': {
            label: 'β⁻',
        ...
        'B-2N': {
            label: 'β⁻+2n',
            title: 'Beta- + 2 neutron emission'
        },
        'B-3N': {
            label: 'β⁻+3n',
            title: 'Beta- + 3 neutron emission'
        },
        'B-4N': {
            label: 'β⁻+4n',
            title: 'Beta- + 4 neutron emission'
        },
        'B-5N': {
            label: 'β⁻+5n',
            title: 'Beta- + 5 neutron emission'
        },
        'B-6N': {
            label: 'β⁻+6n',
            title: 'Beta- + 6 neutron emission'
        },
        'B-7N': {
            label: 'β⁻+7n',
            title: 'Beta- + 7 neutron emission'
        },
        'B-A': {
            label: 'β⁻+α',
            title: 'Beta- + Alpha decay'
        ...
        'B-SF': {
            label: 'β⁻+SF',
            title: 'Beta- + Spontaneous fission'
        },
        'EC': {
            label: 'EC',
        ...
        'EC+B+': {
            label: 'EC+β⁺',
            title: 'Electron capture + Beta+'
        },
        'EC2P': {
            label: 'EC+2p',
            title: 'Electron capture + Two-proton emission'
        },
        'ECA': {
            label: 'EC+α',
            title: 'Electron capture + Alpha decay'
        },
        'ECP': {
            label: 'EC+p',
            title: 'Electron capture + Proton emission'
        },
        'ECSF': {
            label: 'EC+SF',
            title: 'Electron capture + Spontaneous fission'
        },
        'IT': {
            label: 'γ',
            title: 'Isomeric transition (γ)'
        },
        'N': {
            label: 'n',
        ...
        'SF+EC+B+': {
            label: 'SF+EC+β⁺',
            title: 'Spontaneous fission + EC + Beta+'
        },
        'X': {
            label: '{?}',
            title: 'Other decay'
